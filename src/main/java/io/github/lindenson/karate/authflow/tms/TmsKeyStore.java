 ...
 */
public final class TmsKeyStore {
    ...
    public byte[] tmsPublicKey() {
        return tmsPublicKey;
    }

    public void tmsPublicKey(byte[] tmsPublicKey) {
        this.tmsPublicKey = tmsPublicKey;
    }
