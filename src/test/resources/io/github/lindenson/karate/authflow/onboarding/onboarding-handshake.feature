...
Feature: crypto backend device onboarding — handshake flavor (cleartext)

  # Same as standard, but prepended with the Step 0 handshake that fetches the
  # per-device crypto backend public key. The strategy captures it; no crypto in the feature.
